...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'price_monitor_db'),
        'USER': os.getenv('DB_USER', 'monitor_admin'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'secure_password_2026'),
...
# Django'ga avtorizatsiya modelimizni ishlatishga buyuramiz
...
# Configuring the DRF by default
REST_FRAMEWORK = {
